...
export const FighterListItem: React.FC<FighterListItemProps> = ({ fighter, isSelected, onSelect }) => {
  return (
    <div
      className={`p-5 sm:p-4 border-2 rounded-lg active:scale-98 cursor-pointer pointer-events-auto select-none transition-all min-h-[80px] flex items-center shadow-lg ${
        isSelected 
