  ...
  return (
    <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 font-mono text-white select-none">
      ...
      {state === GameState.PLAYING && (
          <div className="absolute bottom-6 right-6 pointer-events-auto z-30 flex flex-col items-center gap-1">
      ...
      {/* Mobile Hint */}
      {state === GameState.PLAYING && (
         <div className="absolute bottom-8 left-0 right-0 text-center text-white/30 text-[10px] pointer-events-none">
