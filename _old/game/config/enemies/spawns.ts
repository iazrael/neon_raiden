...
export const EnemySpawnWeights: Record<number, Record<EnemyType, number>> = {
    ...
    7: { [EnemyType.NORMAL]: 0, [EnemyType.FAST]: 0, [EnemyType.TANK]: 0, [EnemyType.KAMIKAZE]: 1, [EnemyType.ELITE_GUNBOAT]: 1, [EnemyType.LASER_INTERCEPTOR]: 5, [EnemyType.MINE_LAYER]: 0, [EnemyType.PULSAR]: 1, [EnemyType.FORTRESS]: 10, [EnemyType.STALKER]: 1, [EnemyType.BARRAGE]: 0 },

    // 第8关: 1大(KAMIKAZE), 3中(ELITE_GUNBOAT, LASER_INTERCEPTOR, MINE_LAYER), 3小(PULSAR, STALKER, FORTRESS)
    8: { [EnemyType.NORMAL]: 0, [EnemyType.FAST]: 0, [EnemyType.TANK]: 0, [EnemyType.KAMIKAZE]: 1, [EnemyType.ELITE_GUNBOAT]: 1, [EnemyType.LASER_INTERCEPTOR]: 5, [EnemyType.MINE_LAYER]: 0, [EnemyType.PULSAR]: 10, [EnemyType.STALKER]: 1, [EnemyType.FORTRESS]: 1, [EnemyType.BARRAGE]: 1 },
    // 第9关: 1大(KAMIKAZE), 3中(LASER_INTERCEPTOR, MINE_LAYER, PULSAR), 4小(ELITE_GUNBOAT, STALKER, FORTRESS, BARRAGE)
    9: { [EnemyType.NORMAL]: 0, [EnemyType.FAST]: 0, [EnemyType.TANK]: 0, [EnemyType.KAMIKAZE]: 1, [EnemyType.ELITE_GUNBOAT]: 1, [EnemyType.LASER_INTERCEPTOR]: 5, [EnemyType.MINE_LAYER]: 0, [EnemyType.PULSAR]: 1, [EnemyType.STALKER]: 1, [EnemyType.FORTRESS]: 10, [EnemyType.BARRAGE]: 1 },
