...
// src/configs/gallery/weapons.ts
export const GALLERY_WEAPON: Record<string, GalleryEntry> = {
  'vulcan': {
    name: 'Vulcan Gun',
    chineseName: '星裂火神炮',
    desc: '智能弹道预测系统根据敌机密度自动调整扇形覆盖，纳米级表面处理确保远距离精准打击。',
    rarity: 'common',
    unlock: 'default',
    icon: '/assets/gallery/vulcan.png',
  },
  'laser': {
    name: 'Laser Cannon',
    chineseName: '裂空镭射炮',
    desc: '量子纠缠技术聚焦的高能光束，无视护盾直接穿透目标核心。',
    rarity: 'rare',
    unlock: 'level',
    unlockParam: 5,
    icon: '/assets/gallery/laser.png',
  },
  'plasma': {
    name: 'Plasma Cannon',
    chineseName: '等离子炮',
    desc: '反物质约束场封装超高温等离子体，命中后形成微型奇点。',
    rarity: 'epic',
    unlock: 'achievement',
    unlockParam: 10001,
    icon: '/assets/gallery/plasma.png',
  },
};
