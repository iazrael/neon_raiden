// configs/powerupData.ts  （道具静态数据）
import { PowerupType, EntityType } from '@/types';

export const PowerupStaticData: Record<PowerupType, Omit<Entity, 'x' | 'y' | 'vx' | 'vy' | 'hp' | 'maxHp' | 'markedForDeletion'>> = {
    [PowerupType.POWER]: {
